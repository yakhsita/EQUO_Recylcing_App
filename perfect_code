...
root = Tk()
root.title("E-Quo - A Mineral Recycling Application from E-Waste9 - Smart India Hackathon 2022")
bg_color = 'Black'
...
Label = tk.Label(root, text='''\nDear User,  
    ...
    Thanks & Regards,\t
    Team e-Recyclers \t
    A program by : Yakhsita Hansdah, Nishant V H and Priyanshu Singh\t\n\n''', font=("Arial Bold", 10),
...
btn5 = Button(F1, text='Know your device', font='arial 15 bold', command=knowaboutdevice, bg='#8f00ff', bd=2)
btn5.place(x=820, y=5)
btn6 = Button(F1, text='Save-QR Code', font='arial 15 bold', command=save_bill, bg='#8f00ff', bd=2)
btn6.place(x=1030, y=5)
# lable2
